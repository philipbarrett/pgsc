...
sol.it <- gsc.wrapper(dta, dep.var = 'y', indep.var = c('D1','D2'), b.init = b.init, method='onestep')
summary(sol.it)
```
...
sol.2.step.aggte <- gsc.wrapper(dta, dep.var = 'y', indep.var = c('D1','D2'), b.init = sol.it$b, method='twostep.aggte')
sol.2.step.indiv <- gsc.wrapper(dta, dep.var = 'y', indep.var = c('D1','D2'), b.init = sol.2.step.aggte$b, method='twostep.indiv')
sol.compare <- rbind( pan$coefficients[c('D1','D2')], sol.it$b, sol.2.step.aggte$b, sol.2.step.indiv$b, b )
rownames(sol.compare) <- c( 'Panel FEs', 'GSC onestep', 'Aggte two-step GSC', 'Indiv two-step GSC', 'Truth')
print(sol.compare)
```
