...
sol.it <- gsc.wrapper(pgsc.dta, dep.var = 'y', indep.var = c('D1','D2'), b.init = b.init,
                      method='onestep')
summary(sol.it)
```
...
sol.2.step.aggte <- gsc.wrapper(pgsc.dta, dep.var = 'y', indep.var = c('D1','D2'),
                                b.init = sol.it$b, method='twostep.aggte',
                                print.level=-1)
sol.2.step.indiv <- gsc.wrapper(pgsc.dta, dep.var = 'y', indep.var = c('D1','D2'),
...
```{r}
sol.2.step.rest <- gsc.wrapper(pgsc.dta, dep.var = 'y', indep.var = c('D1','D2'), b.init = b.init,
                      method='twostep.indiv', g.i=g, g.i.grad=g.grad )
wald.test.g <- gsc.wald.wrapper( pgsc.dta, dep.var = 'y', indep.var = c('D1','D2'),
...
```{r include=FALSE}
A <- 2
sol.2.step.rest.2 <- gsc.wrapper(pgsc.dta, dep.var = 'y', indep.var = c('D1','D2'), b.init = b.init,
                      method='twostep.indiv', g.i=g, g.i.grad=g.grad )
wald.test.g.2 <- gsc.wald.wrapper( pgsc.dta, dep.var = 'y', indep.var = c('D1','D2'),
                                 sol.rest = sol.2.step.rest.2, n.boot = 10000 )
```

The resulting p-value is close to 0.02.  That is, we can comfortably reject the hypothesis.
